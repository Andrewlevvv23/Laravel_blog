    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Cтворення поста:</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form action="{{ route('posts.store') }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="w-50 form-control" name="title" placeholder="введіть пост" value="{{ old('title') }}">
                                @error('title')
...
{{--{{ is_array( old('tag_ids')) && in_array( $tag_id, old('tag_ids')) ? 'selected' : '' }}--}}
