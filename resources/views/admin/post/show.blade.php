            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        <h2 class="m-0 mr-3"> {{ $post->title }} </h2>
                        <a href="{{ route('posts.edit', $post->id) }}" class="text-success" > <i class="fas fa-pencil-alt"></i> </a>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td> Контент поста </td>
                                            <td  class="text-wrap" style="width: 28rem" > {{ $post->content }} </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
